...
<Library LVVersion="20008000">
	...
	<Item Name="check.array.for.val.vi" Type="VI" URL="../check.array.for.val.vi"/>
	<Item Name="compare.arrays.vi" Type="VI" URL="../compare.arrays.vi"/>
	<Item Name="compare.obs.vi" Type="VI" URL="../compare.obs.vi"/>
	<Item Name="conv.csv.to.ob.cmd.vi" Type="VI" URL="../conv.csv.to.ob.cmd.vi"/>
	<Item Name="conv.pretty.ob.cmd.to.cluster.vi" Type="VI" URL="../conv.pretty.ob.cmd.to.cluster.vi"/>
	<Item Name="conv.price.vi" Type="VI" URL="../conv.price.vi"/>
	<Item Name="conv.symbol.vi" Type="VI" URL="../conv.symbol.vi"/>
	<Item Name="deserialize.ob.cmd.vi" Type="VI" URL="../deserialize.ob.cmd.vi"/>
	<Item Name="get.all.tests.directories.vi" Type="VI" URL="../get.all.tests.directories.vi"/>
	<Item Name="ob.cmd.to.str.vi" Type="VI" URL="../ob.cmd.to.str.vi"/>
	<Item Name="serialize.ob.cmd.vi" Type="VI" URL="../serialize.ob.cmd.vi"/>
	<Item Name="str.to.ob.cmd.vi" Type="VI" URL="../str.to.ob.cmd.vi"/>
	...
	<Item Name="val.pretty.orderbook.ctl" Type="VI" URL="../val.pretty.orderbook.ctl"/>
</Library>
