...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			<Item Name="test.to.str.Time.vi" Type="VI" URL="../host/tests/test.to.str.Time.vi"/>
			<Item Name="test.to.str.AddOrder.1.vi" Type="VI" URL="../host/tests/test.to.str.AddOrder.1.vi"/>
			<Item Name="test.from.str.AddOrder.vi" Type="VI" URL="../host/tests/test.from.str.AddOrder.vi"/>
			<Item Name="test.from.str.Time.vi" Type="VI" URL="../host/tests/test.from.str.Time.vi"/>
		</Item>
...
set_property IOSTANDARD LVCMOS25 [get_ports {Si570Clkn}]
			...
			<Property Name="niFpga_TopLevelVIID" Type="Path">/C/work/fpganow/Market.Data.Common/fpga/util/seri.booleans.vi</Property>
			...
			<Item Name="Dependencies" Type="Dependencies">
				...
				<Item Name="my.network.data.stream.ctl" Type="VI" URL="../fpga/my.network.data.stream.ctl"/>
			</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="fpganow.common" Type="Source Distribution">
				...
				<Property Name="Bld_excludedDirectory[3]" Type="Path">/C/Users/johns/OneDrive/Documents/LabVIEW Data/2020(32-bit)/ExtraVILib</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{1FE49B62-9E2B-4919-B1F4-6210ECC072FE}</Property>
