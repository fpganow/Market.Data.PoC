...
module xgmii2axis (
    ...
    // AXIS for Zynq PS
    input                    ARESETN,
    output reg   [63:0]      zy_TDATA,
    output reg   [7:0]       zy_TKEEP,
    output reg               zy_TVALID,
    output reg               zy_TLAST,
    output reg   [0:0]       zy_TUSER,

    // AXIS for LabVIEW
    output reg   [63:0]      lv_TDATA,
    output reg   [7:0]       lv_TKEEP,
    output reg               lv_TVALID,
    output reg               lv_TLAST,
    output reg   [0:0]       lv_TUSER
    );
    ...
    always @(posedge clk) begin
        ...
        if (rst) begin  // rst
            ...
            if (zy_TVALID && zy_TLAST && zy_TUSER[0]) begin
